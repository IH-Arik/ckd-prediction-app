...
with 96.4% CKD detection accuracy.
""")
...
def make_prediction(input_data):
    ...
    try:
        ...
        **Fixed Model Statistics:**
        ...
        This model has been specifically trained and validated to address class imbalance 
        issues and provides reliable CKD risk assessment.
        """)
